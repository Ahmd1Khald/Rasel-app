...
import 'package:RASEL/Features/user/presentation/manger/user_cubit.dart';
...
class UserProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
        create: (context) =>
            UserCubit(UserRepoImplement())..fetchUserData(uid: uid),
                        ...
                        Align(
                          ...
                          child: CircleAvatar(
                            ...
                            child: ClipRRect(
                              ...
                              child: cubit.profilePath != null
                                  ? Image.file(cubit.profilePath!)
                                  : CachedNetworkImage(
                                      fit: BoxFit.cover,
                                      width: 118.w,
                                      height: 108.h,
